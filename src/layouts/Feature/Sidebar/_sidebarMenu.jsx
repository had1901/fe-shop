...
export const renderMenuItems = (menus) => {
    return menus.map((menu) => (
      <li key={menu.id} data-index={menu.id} className={clsx(styles.menuItem)}>
        <a href="#" className={clsx(styles.menuItemLink)}>
          <i className={clsx(styles.menuItemIcon)}>{menu.icon}</i>
          <span className={clsx(styles.menuItemText)}>{menu.label}</span>
          <span className={clsx(styles.menuItemArrow)}><TiChevronRight /></span>
        </a>
